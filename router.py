...
from mod.user_agreement.problem import ProblemHandler
...
from mod.market.list_evaluations import ListEvaluationsHandler
from mod.scroll_image.get_scroll_image import GetScrollImageHandler
from mod.feed_back.user_feed_back import UserFeedBackHandler
from mod.feed_back.get_service_hotline import GetServiceHotlineHandler

handlers=(
    (r'/bangzai/user_agreement', UserAgreementHandler),
    (r'/bangzai/problem', ProblemHandler),
    ...
    (r'/bangzai/market/list_evaluations',ListEvaluationsHandler),
    (r'/bangzai/scroll_image/get_scroll_image',GetScrollImageHandler),
    (r'/bangzai/feed_back/user_feed_back',UserFeedBackHandler),
    (r'/bangzai/feed_back/get_service_hotline',GetServiceHotlineHandler),
)
